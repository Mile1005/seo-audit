...
export class ToxicityAnalyzer {
   ...
   */
  calculateToxicity(backlink: BacklinkData, domain?: ReferringDomainData): ToxicityScore {
    const breakdown = {
   ...
   */
  private scoreDomainQuality(backlink: BacklinkData, domain?: ReferringDomainData): number {
    let score = 0;
   ...
   */
  private scoreSpamIndicators(backlink: BacklinkData, domain?: ReferringDomainData): number {
    let score = 0;
