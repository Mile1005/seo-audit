...
export function handleCTAClick(
  ...
  const url = destination in CTA_DESTINATIONS 
...
export function createCTAProps(
  ...
  const variantClasses = {
    ...
    secondary: 'bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white shadow-lg hover:shadow-cyan-500/25 transform hover:scale-105 focus:ring-cyan-500',
    outline: 'bg-white/5 hover:bg-white/10 border border-white/20 hover:border-white/30 text-white backdrop-blur-sm focus:ring-white/50'
  }
