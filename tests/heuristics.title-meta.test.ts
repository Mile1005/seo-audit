...
test("title length scoring - optimal length gets high score", () => {
  ...
  const parsed: ParsedHtml = {
    ...
    metaDescription: "Learn the essential SEO best practices for 2024. Discover proven strategies to improve your search rankings and drive organic traffic.",
    canonical: null,
...
test("title length scoring - too long title gets low score", () => {
  const url = "https://example.com";
  const parsed: ParsedHtml = {
    title: "This is an extremely long title that exceeds the recommended character limit for search engine optimization and will likely be truncated in search results which is not ideal for user experience and click-through rates",
    metaDescription: "A very long meta description that also exceeds the recommended character limit for optimal display in search engine results pages.",
    canonical: null,
    h1: "Long Title Test",
    h2: [],
    h3: [],
...
test("keyword inclusion in title improves score", () => {
  ...
  const keywordIssue = resWithoutKeyword.issues.find(issue => issue.id === "keyword-missing-title");
...
test("meta description length scoring", () => {
  ...
  const parsedOptimal: ParsedHtml = {
    title: "SEO Guide",
    metaDescription: "Learn the essential SEO best practices for 2024. Discover proven strategies to improve your search rankings and drive organic traffic to your website.",
    canonical: null,
    h1: "SEO Guide",
    h2: [],
    h3: [],
