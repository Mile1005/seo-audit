...
test.describe('User Authentication Flows', () => {
  ...
  test('Social login buttons functionality', async ({ page }) => {
    ...
    const githubButton = page.locator('button:has-text("GitHub"), a:has-text("GitHub"), [data-provider="github"]');
  ...
  test('Account management after login', async ({ page }) => {
    ...
    const profileLink = page.locator('a:has-text("Profile"), a:has-text("Account"), [data-testid="profile"]');
