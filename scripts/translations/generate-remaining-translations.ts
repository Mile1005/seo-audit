      ...
      features: {
        items: {
          ...
          competitorAnalysis: {
            ...
            desc: "Bandingkan performa Anda dengan kompetitor",
          },
          keywordTracking: {
            title: "Keyword Tracking",
            desc: "Pantau peringkat dan performa pencarian",
          },
          siteCrawler: {
            title: "Site Crawler",
            desc: "Analisis teknis SEO mendalam dan pemantauan",
          },
    ...
    menu: {
      features: {
        items: {
          ...
          competitorAnalysis: {
            title: "Competitor Analysis",
            desc: "Vergleichen Sie Ihre Leistung mit Wettbewerbern",
          },
          keywordTracking: {
            title: "Keyword Tracking",
            desc: "Überwachen Sie Rankings und Suchleistung",
          },
          siteCrawler: {
            title: "Site Crawler",
            desc: "Tiefgehende technische SEO-Analyse und Überwachung",
          },
          aiAssistant: {
            title: "AI Assistant",
            desc: "Intelligente SEO-Empfehlungen und Einblicke",
          },
        },
      },
    },
...
async function generateTranslations() {
  ...
  fs.writeFileSync(path.join(messagesDir, "id.json"), JSON.stringify(idContent, null, 2), "utf-8");
  console.log("✅ Generated id.json (Indonesian)");

  // Generate German
  const deContent = translateObject(enContent, germanTranslations);
  fs.writeFileSync(path.join(messagesDir, "de.json"), JSON.stringify(deContent, null, 2), "utf-8");
