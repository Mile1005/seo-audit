...
// Italian Translation
const it = JSON.parse(JSON.stringify(sourceData)
...
// Spanish Translation  
const es = JSON.parse(JSON.stringify(sourceData)
...
const id = JSON.parse(JSON.stringify(sourceData)
...
// German Translation
const de = JSON.parse(JSON.stringify(sourceData)
