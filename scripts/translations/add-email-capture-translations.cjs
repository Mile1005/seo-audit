...
const translations = {
  ...
  fr: {
    ...
    description:
      "Rejoignez plus de 10 000 spécialistes du marketing recevant chaque semaine des insights SEO actionnables",
    ...
    success: {
      ...
      message:
        "Votre liste de contrôle SEO gratuite est en route. N'oubliez pas de vérifier votre dossier spam !",
  ...
  es: {
    ...
    description:
      "Únase a más de 10,000 especialistas en marketing que reciben insights SEO accionables semanalmente",
    ...
    success: {
      ...
      message:
        "Su lista de verificación SEO gratuita está en camino. ¡No olvide revisar su carpeta de spam!",
  ...
  de: {
    ...
    description:
      "Schließen Sie sich über 10.000 Marketingexperten an, die wöchentlich umsetzbare SEO-Insights erhalten",
    ...
    success: {
      ...
      message:
        "Ihre kostenlose SEO-Checkliste ist unterwegs. Vergessen Sie nicht, Ihren Spam-Ordner zu überprüfen!",
  ...
  it: {
    ...
    description:
      "Unisciti a oltre 10.000 professionisti del marketing che ricevono insights SEO azionabili settimanalmente",
    placeholder: "Inserisci il tuo indirizzo email",
    ctaText: "Ottieni Lista Gratuita",
    sending: "Invio in corso...",
    trustSignal:
      "📧 Niente spam, disiscriviti in qualsiasi momento • 🔒 I tuoi dati sono al sicuro",
    success: {
      title: "Successo! Controlla la Tua Email",
      message:
        "La tua lista di controllo SEO gratuita è in arrivo. Non dimenticare di controllare la cartella spam!",
  ...
  id: {
    ...
    description:
      "Bergabunglah dengan lebih dari 10.000 pemasar yang menerima wawasan SEO yang dapat ditindaklanjuti setiap minggu",
    ...
    success: {
      ...
      message:
        "Daftar periksa SEO gratis Anda sedang dalam perjalanan. Jangan lupa periksa folder spam Anda!",
