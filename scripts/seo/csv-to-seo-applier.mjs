...
class CSVToSEOApplier {
  ...
  updateSEOConfig() {
    ...
    const generateSEOMetaRegex =
      /export function generateSEOMeta\(config: SEOConfig\): Metadata \{\s*const \{ title, description, keywords, canonical, ogImage, ogType, twitterCard, noIndex, structuredData, locale, path \} = config;\s*[\s\S]*?return \{\s*title: title,\s*[\s\S]*?\};/;
  ...
  generateDescription(pagePath, locale) {
    ...
    const descriptions = {
      en: {
        ...
        contact:
          "Get expert SEO help from certified specialists. Contact us for personalized consultation, technical support, and partnership inquiries.",
      ...
      fr: {
        ...
        features:
          "Découvrez de puissantes fonctionnalités SEO incluant des audits techniques, l'analyse concurrentielle, le suivi des mots-clés et des recommandations IA.",
        pricing:
          "Choisissez le plan d'audit SEO parfait pour votre entreprise. Plan gratuit avec analyse, plans Pro dès 29$/mois avec fonctionnalités avancées.",
        about:
          "Découvrez la mission d'AISEOTurbo de révolutionner le SEO avec la technologie IA. Rencontrez notre équipe d'experts engagés à aider les entreprises.",
        contact:
          "Obtenez de l'aide SEO experte de spécialistes certifiés. Contactez-nous pour des consultations personnalisées et du support technique.",
      ...
      de: {
        ...
        features:
          "Entdecken Sie leistungsstarke SEO-Funktionen einschließlich technischer Audits, Wettbewerbsanalysen, Keyword-Tracking und KI-Empfehlungen.",
        pricing:
          "Wählen Sie den perfekten SEO-Audit-Plan für Ihr Unternehmen. Kostenloser Plan mit Analyse, Pro-Pläne ab 29$/Monat mit erweiterten Funktionen.",
        about:
          "Entdecken Sie die Mission von AISEOTurbo, SEO mit KI-Technologie zu revolutionieren. Treffen Sie unser Expertenteam für Geschäftserfolg online.",
        contact:
          "Erhalten Sie professionelle SEO-Hilfe von zertifizierten Spezialisten. Kontaktieren Sie uns für personalisierte Beratung und technischen Support.",
      ...
      es: {
        ...
        features:
          "Descubre poderosas funciones SEO incluyendo auditorías técnicas, análisis de competidores, seguimiento de palabras clave y recomendaciones de IA.",
        pricing:
          "Elige el plan de auditoría SEO perfecto para tu negocio. Plan gratuito con análisis, planes Pro desde 29$/mes con funciones avanzadas.",
        about:
          "Descubre la misión de AISEOTurbo de revolucionar el SEO con tecnología de IA. Conoce a nuestro equipo de expertos comprometidos con el éxito empresarial.",
        contact:
          "Obtén ayuda SEO experta de especialistas certificados. Contáctanos para consultas personalizadas, soporte técnico y oportunidades de partnership.",
      ...
      it: {
        ...
        features:
          "Scopri potenti funzionalità SEO inclusi audit tecnici, analisi concorrenti, monitoraggio keywords e raccomandazioni IA per migliori posizionamenti.",
        pricing:
          "Scegli il piano di audit SEO perfetto per la tua azienda. Piano gratuito con analisi, piani Pro da 29$/mese con funzionalità avanzate.",
        about:
          "Scopri la missione di AISEOTurbo di rivoluzionare il SEO con tecnologia IA. Incontra il nostro team di esperti impegnati ad aiutare le aziende online.",
        contact:
          "Ottieni aiuto SEO esperto da specialisti certificati. Contattaci per consulenze personalizzate, supporto tecnico e opportunità di partnership.",
      ...
      id: {
        ...
        features:
          "Temukan fitur SEO powerful termasuk audit teknis, analisis kompetitor, pelacakan kata kunci, dan rekomendasi bertenaga AI untuk ranking lebih baik.",
        pricing:
          "Pilih paket audit SEO yang sempurna untuk bisnis Anda. Paket gratis dengan analisis, paket Pro mulai dari $29/bulan dengan fitur advanced.",
        about:
          "Temukan misi AISEOTurbo untuk merevolusi SEO dengan teknologi AI. Temui tim ahli kami yang berkomitmen membantu bisnis sukses secara online.",
        contact:
          "Dapatkan bantuan SEO ahli dari spesialis bersertifikat. Hubungi kami untuk konsultasi personal, dukungan teknis, dan kesempatan partnership.",
    ...
    let baseDesc =
      descriptions[locale]?.[pagePath] ||
      descriptions["en"][pagePath] ||
      "Comprehensive AI-powered SEO audit and optimization tools for better search rankings.";
  ...
  generateKeywords(pagePath, locale) {
    ...
    return (
      keywordSets[locale]?.[pagePath] ||
      keywordSets["en"][pagePath] || ["SEO audit", "SEO optimization", "AI SEO tools"]
    );
  }
  ...
  updatePageComponents() {
    ...
    for (const page of pagesToUpdate) {
      ...
      try {
        ...
        const oldMetadataCall =
          /return generateSEOMeta\(\{\s*title: pageSEO\.\w+\.title,[\s\S]*?locale: locale as Locale,[\s\S]*?path: ['"](.*?)['"]\s*\}\)/;
  ...
  printSummary() {
    ...
    LOCALES.forEach((locale) => {
      ...
      console.log(
        `   ${locale.toUpperCase()}: ${pageCount}/${this.pageSEOMap.size} pages localized`
      );
    });
