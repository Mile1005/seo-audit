        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              {/* Website Snapshot */}
              <div className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">Website Snapshot</h2>
                <div className="bg-gray-100 rounded-lg p-6">
                  <div className="text-sm text-gray-600 mb-2">Analyzing Website</div>
              ...
              {/* Analyzing Message */}
              <div className="mb-8">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Analyzing website...</h3>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-center space-x-3">
                  ...
                  <span className="text-gray-700">Fetching page content...</span>
                </div>
                <div className="flex items-center justify-center space-x-3">
                  <div className="w-3 h-3 bg-blue-500 rounded-full animate-pulse"></div>
                  <span className="text-gray-700">Analyzing SEO elements...</span>
                </div>
                <div className="flex items-center justify-center space-x-3">
                  <div className="w-3 h-3 bg-purple-500 rounded-full animate-pulse"></div>
                  <span className="text-gray-700">Checking performance...</span>
                </div>
                <div className="flex items-center justify-center space-x-3">
