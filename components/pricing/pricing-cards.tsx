  ...
  return (
    <section className="py-20 bg-gradient-to-b from-slate-900 to-slate-950 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              >
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-400 text-sm mb-6">{t(`plans.${plan.id}.description`)}</p>
        ...
        >
          <p className="text-gray-400 mb-6">{t("footer.notSure")}</p>
          <motion.button
