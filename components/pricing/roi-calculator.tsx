      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              <div>
                <h3 className="text-2xl font-bold text-white mb-6">{t("inputs.title")}</h3>
                ...
                <div className="mt-8 p-4 bg-slate-800/30 rounded-xl border border-slate-700/30">
                  <h4 className="text-sm font-medium text-white mb-2">{t("assumptions.title")}</h4>
            ...
            >
              <div>
                <h3 className="text-2xl font-bold text-white mb-6">{t("results.title")}</h3>
                ...
                {results ? (
                  <div className="space-y-6">
                    ...
                    <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 border border-green-500/20 rounded-xl p-6">
                      ...
                      <div className="text-green-400 text-sm">{t("results.annualRevenue")}</div>
                    </div>
                  ...
                  <div className="bg-slate-800/30 border border-slate-700/30 rounded-xl p-8 text-center">
                    ...
                    <p className="text-gray-400">{t("results.noPlan")}</p>
                  </div>
                )}
              </div>
            </motion.div>
