    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          {/* Left: Features */}
          <div>
            <h3 className="text-2xl font-bold text-foreground mb-6">{t("interactiveMapping")}</h3>
                      ...
                      <ul className="space-y-1">
                        {feature.benefits.map((benefit, benefitIndex) => (
                          <motion.li
                            ...
                            transition={{
                              duration: 0.3,
                              delay: 0.7 + index * 0.1 + benefitIndex * 0.05,
                            }}
        ...
        >
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl font-bold text-foreground mb-4">{t("urlOptimization")}</h3>
              <p className="text-muted-foreground mb-6">{t("urlOptimizationDesc")}</p>
