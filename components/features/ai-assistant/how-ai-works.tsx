...
export default function HowAiWorks() {
  ...
  const trainingData = [
    {
      source: t("training.source1.name"),
      count: t("training.source1.count"),
      description: t("training.source1.description"),
    },
    {
      source: t("training.source2.name"),
      count: t("training.source2.count"),
      description: t("training.source2.description"),
    },
    {
      source: t("training.source3.name"),
      count: t("training.source3.count"),
      description: t("training.source3.description"),
    },
    {
      source: t("training.source4.name"),
      count: t("training.source4.count"),
      description: t("training.source4.description"),
    },
    {
      source: t("training.source5.name"),
      count: t("training.source5.count"),
      description: t("training.source5.description"),
    },
    {
      source: t("training.source6.name"),
      count: t("training.source6.count"),
      description: t("training.source6.description"),
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-foreground mb-4">{t("training.title")}</h3>
            <p className="text-muted-foreground max-w-2xl mx-auto">{t("training.subtitle")}</p>
          </div>
