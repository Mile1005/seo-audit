...
const HowAIWorks = dynamic(() => import('@/components/features/ai-assistant/how-ai-works'), { ssr: false })
const RecommendationTypes = dynamic(() => import('@/components/features/ai-assistant/recommendation-types'), { ssr: false })
const IndustrySpecialization = dynamic(() => import('@/components/features/ai-assistant/industry-specialization'), { ssr: false })
const ImplementationGuides = dynamic(() => import('@/components/features/ai-assistant/implementation-guides'), { ssr: false })
const AIAssistantHero = dynamic(() => import('@/components/features/ai-assistant/ai-assistant-hero').then(mod => ({ default: mod.AIAssistantHero })), { ssr: false })
