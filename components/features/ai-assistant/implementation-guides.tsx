...
getLCP(console.log);
getTTFB(console.log);`,
        tools: [t('steps.coreWebVitals.step1.tools.tool1'), t('steps.coreWebVitals.step1.tools.tool2'), t('steps.coreWebVitals.step1.tools.tool3')],
...
<img src="/hero-image.webp" 
     ...
     alt="Hero image" 
     loading="eager" />`,
        tools: [t('steps.coreWebVitals.step2.tools.tool1'), t('steps.coreWebVitals.step2.tools.tool2'), t('steps.coreWebVitals.step2.tools.tool3')],
...
worker.postMessage(data);`,
        tools: [t('steps.coreWebVitals.step3.tools.tool1'), t('steps.coreWebVitals.step3.tools.tool2'), t('steps.coreWebVitals.step3.tools.tool3')],
...
.ad-container {
  ...
  background: #f0f0f0;
        ...
        tools: [t('steps.coreWebVitals.step4.tools.tool1'), t('steps.coreWebVitals.step4.tools.tool2'), t('steps.coreWebVitals.step4.tools.tool3')],
        ...
        code: `// Organization Schema (for homepage)
{
  ...
  "contactPoint": {
    ...
    "contactType": "customer service"
        ...
        tools: [t('steps.schemaMarkup.step1.tools.tool1'), t('steps.schemaMarkup.step1.tools.tool2'), t('steps.schemaMarkup.step1.tools.tool3')],
        ...
        code: `// Service Schema
{
  ...
  "offers": {
    ...
    "availability": "https://schema.org/InStock"
        ...
        tools: [t('steps.schemaMarkup.step2.tools.tool1'), t('steps.schemaMarkup.step2.tools.tool2'), t('steps.schemaMarkup.step2.tools.tool3')],
      ...
      <div className="max-w-7xl mx-auto overflow-hidden">
                    ...
                    <div className="bg-slate-900 rounded-lg overflow-hidden mb-4 max-w-full">
                      <div className="flex items-center justify-between p-3 bg-slate-800">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm text-gray-300">{t('labels.implementationCode')}</span>
                        </div>
        ...
        >
          <div className="bg-card rounded-lg border p-6 text-center">
            ...
            <Button variant="outline" size="sm">{t('resources.pdfGuides.button')}</Button>
          </div>
          
          <div className="bg-card rounded-lg border p-6 text-center">
            <Play className="w-8 h-8 text-green-600 mx-auto mb-4" />
            <h4 className="font-semibold text-foreground mb-2">{t('resources.videoTutorials.title')}</h4>
            <p className="text-sm text-muted-foreground mb-4">
              {t('resources.videoTutorials.description')}
            </p>
            <Button variant="outline" size="sm">{t('resources.videoTutorials.button')}</Button>
          </div>
          
          <div className="bg-card rounded-lg border p-6 text-center">
            <Users className="w-8 h-8 text-purple-600 mx-auto mb-4" />
            <h4 className="font-semibold text-foreground mb-2">{t('resources.expertSupport.title')}</h4>
            <p className="text-sm text-muted-foreground mb-4">
              {t('resources.expertSupport.description')}
            </p>
            <Button variant="outline" size="sm">{t('resources.expertSupport.button')}</Button>
          </div>
        </motion.div>
      </div>
    </section>
