        ...
        >
          {results.map((result, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${result.color} opacity-0 group-hover:opacity-5 transition-opacity duration-300`}
                />
                <div className="relative z-10">
                  <div
                    className={`inline-flex p-3 rounded-lg bg-gradient-to-br ${result.color} mb-4 group-hover:scale-110 transition-transform duration-300`}
                  >
