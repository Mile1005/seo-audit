        ...
        <section className="py-20 px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8 flex justify-center">
              <Breadcrumbs
                items={[{ name: "Features", url: "https://www.aiseoturbo.com/features" }]}
                darkMode={false}
              />
            </div>
        ...
        <section className="py-16 px-4 bg-muted/30">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg prose-invert mx-auto">
              ...
              <p>{t("intro.whyChooseText")}</p>

              <h3>{t("intro.technicalTitle")}</h3>
              <p>{t("intro.technicalText")}</p>
              <ul>
              ...
              <p>{t("intro.expertP1")}</p>

              <p>{t("intro.expertP2")}</p>
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="relative overflow-hidden border border-border/50 rounded-lg bg-card text-card-foreground shadow-sm hover:border-primary/50 transition-colors"
                  >
                    {feature.popular && (
