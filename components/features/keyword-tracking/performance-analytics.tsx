...
export default function PerformanceAnalytics() {
  ...
  const keywordPerformance = [
    {
      keyword: t("keywordTable.keywords.keyword1"),
      position: 3,
      change: +2,
      traffic: 1247,
      difficulty: 65,
    ...
    {
      keyword: t("keywordTable.keywords.keyword2"),
      position: 7,
      change: +1,
      traffic: 892,
      difficulty: 58,
    ...
    {
      keyword: t("keywordTable.keywords.keyword3"),
      position: 12,
      change: +5,
      traffic: 634,
      difficulty: 72,
    ...
    {
      keyword: t("keywordTable.keywords.keyword4"),
      position: 15,
      change: +3,
      traffic: 445,
      difficulty: 55,
    ...
    {
      keyword: t("keywordTable.keywords.keyword5"),
      position: 8,
      change: -1,
      traffic: 723,
      difficulty: 68,
        ...
        >
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center space-x-2 text-sm text-muted-foreground">
              ...
              <span>
                {t("chart.last")} {timeframes.find((t) => t.id === selectedTimeframe)?.label}
              </span>
            </div>
          </div>
          ...
          <div className="h-64 bg-muted/30 rounded-lg flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground mt-2">{t("chart.drillDown")}</p>
            </div>
          </div>
        </motion.div>
              ...
              <thead>
                <tr className="border-b border-border">
                  <th className="text-left py-3 px-2 text-sm font-medium text-muted-foreground">
                    {t("keywordTable.headers.keyword")}
                  </th>
                  <th className="text-left py-3 px-2 text-sm font-medium text-muted-foreground">
                    {t("keywordTable.headers.position")}
                  </th>
                  <th className="text-left py-3 px-2 text-sm font-medium text-muted-foreground">
                    {t("keywordTable.headers.change")}
                  </th>
                  <th className="text-left py-3 px-2 text-sm font-medium text-muted-foreground">
                    {t("keywordTable.headers.traffic")}
                  </th>
                  <th className="text-left py-3 px-2 text-sm font-medium text-muted-foreground">
                    {t("keywordTable.headers.difficulty")}
                  </th>
                </tr>
              </thead>
              <tbody>
