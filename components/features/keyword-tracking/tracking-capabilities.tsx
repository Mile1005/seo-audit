...
export default function TrackingCapabilities() {
  ...
  const plans = [
    ...
    },
    {
      ...
      devices: [
        t("plans.professional.devices.desktop"),
        t("plans.professional.devices.mobile"),
        t("plans.professional.devices.tablet"),
      ],
  ...
  const locationExamples = [
    {
      country: t("locations.unitedStates.country"),
      cities: t("locations.unitedStates.cities"),
      flag: "🇺🇸",
    },
    {
      country: t("locations.unitedKingdom.country"),
      cities: t("locations.unitedKingdom.cities"),
      flag: "🇬🇧",
    },
    { country: t("locations.canada.country"), cities: t("locations.canada.cities"), flag: "🇨🇦" },
    {
      country: t("locations.australia.country"),
      cities: t("locations.australia.cities"),
      flag: "🇦🇺",
    },
      ...
      <div className="max-w-7xl mx-auto">
            ...
            return (
              ...
              >
                <div className="flex items-start space-x-4">
                  <div
                    className={`w-12 h-12 rounded-lg bg-gradient-to-br ${getFeatureColor(feature.color)} flex items-center justify-center flex-shrink-0`}
                  >
        ...
        >
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-foreground mb-4">{t("globalCoverage.title")}</h3>
        ...
        >
          <div className="p-8 border-b">
            <h3 className="text-2xl font-bold text-foreground mb-4">{t("plansSection.title")}</h3>
            <p className="text-muted-foreground">{t("plansSection.subtitle")}</p>
          </div>
        ...
        >
          <div className="bg-card border rounded-xl p-8">
            <h3 className="text-xl font-bold text-foreground mb-4">{t("setupCta.title")}</h3>
