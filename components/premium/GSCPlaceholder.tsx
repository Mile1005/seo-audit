      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-600 mt-1 max-w-xl">
            Connect your verified property to sync query, page, and device performance. Correlate
            technical fixes with visibility gains and export blended reports.
          </p>
        </div>
        <div className="flex gap-2">
          <button
            className="px-3 py-1.5 text-sm rounded-md bg-emerald-600 text-white hover:bg-emerald-500"
            data-upsell="gsc-connect"
          >
            Connect GSC
          </button>
          <button
