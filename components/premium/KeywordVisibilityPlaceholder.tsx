      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-600 mt-1 max-w-xl">
            Track daily positions, share of voice, and SERP feature presence. Connect a ranking
            provider to enable automatic refresh, competitor overlays, and anomaly alerts.
          </p>
        </div>
        <div className="flex gap-2">
          <button
            className="px-3 py-1.5 text-sm rounded-md bg-indigo-600 text-white hover:bg-indigo-500"
            data-upsell="keywords-upgrade"
          >
            Upgrade
          </button>
          <button
      ...
      <div className="mt-4 grid grid-cols-2 gap-4 text-sm">
        ...
        <div>
          ...
          <p className="text-slate-700">
            Top 3: {demo.distribution.top3} • Top 10: {demo.distribution.top10} • Top 20:{" "}
            {demo.distribution.top20}
          </p>
        </div>
      </div>
