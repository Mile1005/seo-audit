    ...
    >
      <div className="text-center">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-2">
          Welcome to SEO Audit
        </h2>
        <p className="text-gray-600 mb-8">
          Sign in to access your personalized SEO analysis and track your progress
        </p>
        
        <button
          onClick={handleGoogleSignIn}
          disabled={isLoading}
          className="w-full bg-white hover:bg-gray-50 disabled:bg-gray-100 text-gray-900 font-medium py-3 px-4 rounded-xl border-2 border-gray-200 transition-all duration-200 flex items-center justify-center space-x-3 shadow-sm hover:shadow-md"
        >
          {isLoading ? (
