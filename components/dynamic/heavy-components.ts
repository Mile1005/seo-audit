...
export const DynamicTestimonialsCarousel = createDynamicComponent(() => 
  import("@/components/testimonials/testimonials-carousel").then(m => ({ default: m.TestimonialsCarousel }))
);

export const DynamicCaseStudyPreview = createDynamicComponent(() => 
  import("@/components/testimonials/case-study-preview").then(m => ({ default: m.CaseStudyPreview }))
);
