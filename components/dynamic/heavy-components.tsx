...
export const DynamicFeaturesShowcase = dynamic(() => import("../features/features-showcase"), {
  loading: () => (
...
export const DynamicInteractiveDemo = dynamic(() => import("../demo/interactive-demo"), {
  loading: () => (
...
export const DynamicROICalculator = dynamic(() => import("../pricing/roi-calculator"), {
  loading: () => (
...
export const DynamicPricingCards = dynamic(() => import("../pricing/pricing-cards"), {
  loading: () => (
    <div className="h-64 bg-gray-900 dark:bg-gray-900 animate-pulse rounded-lg flex items-center justify-center">
