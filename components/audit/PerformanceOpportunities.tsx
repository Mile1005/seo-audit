...
const getImplementationDetails = (title: string): Opportunity["implementation"] => {
  ...
  if (
    ...
    (normalizedTitle.includes("optimize") || normalizedTitle.includes("compress"))
  ) {
    return {
      steps: [
                  ...
                  {isExpanded && (
                    ...
                    >
                      <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <div className="p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg">
                              <p className="text-sm text-blue-800 dark:text-blue-200 mb-2">
                                <strong>⚡ Direct Integration:</strong> We’ve analyzed your site
                                using advanced performance tools so you don’t need to visit external
                                platforms.
                              </p>
                              <p className="text-sm text-blue-700 dark:text-blue-300">
                                <strong>🎯 Actionable Results:</strong> Follow the implementation
                                steps above for immediate improvements.
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        <div>
                          <h5 className="font-semibold text-slate-900 dark:text-slate-100 mb-3 flex items-center gap-2">
                            <div className="w-5 h-5 bg-green-500 rounded text-white text-xs flex items-center justify-center">
                              🎯
                            </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            <div className="p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg">
                              ...
                              <p className="text-xs text-green-700 dark:text-green-300">
                                Our support team can provide personalized guidance for your specific
                                setup.
                              </p>
                            </div>
