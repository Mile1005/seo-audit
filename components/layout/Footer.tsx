  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        {
          label: t("sections.product.links.competitorAnalysis"),
        ...
        <div className="py-8 border-t border-slate-800">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6">
              <Link
                href="/privacy"
                className="text-gray-400 hover:text-white transition-colors text-sm py-2 px-1 min-h-[44px] min-w-[44px] flex items-center"
              >
                {t("links.privacy")}
              </Link>
              <Link
