...
export function AnimatedAuditVisualization({
  progress: propProgress,
  url = "Analyzing...",
}: AnimatedAuditVisualizationProps) {
    ...
    const items: CheckItem[] = [
      {
        ...
        status:
          progress.progress > 15 ? "complete" : progress.progress > 10 ? "checking" : "pending",
        delay: 0.1,
      },
      {
        ...
        status:
          progress.progress > 35 ? "complete" : progress.progress > 25 ? "checking" : "pending",
        delay: 0.2,
      },
      {
        ...
        status:
          progress.progress > 50 ? "complete" : progress.progress > 40 ? "checking" : "pending",
        delay: 0.3,
      },
      {
        ...
        status:
          progress.progress > 65 ? "complete" : progress.progress > 55 ? "checking" : "pending",
        delay: 0.4,
      },
      {
        ...
        status:
          progress.progress > 75 ? "complete" : progress.progress > 68 ? "checking" : "pending",
        delay: 0.5,
      },
      {
        ...
        status:
          progress.progress > 85 ? "complete" : progress.progress > 78 ? "checking" : "pending",
        delay: 0.6,
      },
      {
        ...
        status:
          progress.progress > 92 ? "complete" : progress.progress > 87 ? "checking" : "pending",
        delay: 0.7,
      },
      {
        ...
        status:
          progress.progress > 98 ? "complete" : progress.progress > 93 ? "checking" : "pending",
        delay: 0.8,
      },
    ];
