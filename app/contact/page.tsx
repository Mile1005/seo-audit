        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6">
              {t('hero.titlePrefix')} <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400">{t('hero.titleHighlight')}</span>
            </h1>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <div className="text-center p-6 bg-muted/30 rounded-xl hover:bg-muted/50 transition-all duration-200">
              ...
              <h3 className="text-lg font-semibold text-foreground mb-2">{t('services.cards.technical.title')}</h3>
              <p className="text-muted-foreground text-sm">{t('services.cards.technical.desc')}</p>
            </div>
            ...
            <div className="text-center p-6 bg-muted/30 rounded-xl hover:bg-muted/50 transition-all duration-200">
              ...
              <h3 className="text-lg font-semibold text-foreground mb-2">{t('services.cards.strategy.title')}</h3>
            ...
            <div className="text-center p-6 bg-muted/30 rounded-xl hover:bg-muted/50 transition-all duration-200">
              ...
              <h3 className="text-lg font-semibold text-foreground mb-2">{t('services.cards.training.title')}</h3>
            ...
            <div className="text-center p-6 bg-muted/30 rounded-xl hover:bg-muted/50 transition-all duration-200">
              ...
              <h3 className="text-lg font-semibold text-foreground mb-2">{t('services.cards.partnerships.title')}</h3>
              <p className="text-muted-foreground text-sm">{t('services.cards.partnerships.desc')}</p>
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground mb-1">{t('why.items.certified.title')}</h3>
                    <p className="text-muted-foreground text-sm">{t('why.items.certified.desc')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground mb-1">{t('why.items.fast.title')}</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground mb-1">{t('why.items.steps.title')}</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground mb-1">{t('why.items.results.title')}</h3>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 p-8 rounded-2xl border border-border">
                <h3 className="text-xl font-semibold text-foreground mb-6 text-center">{t('why.guarantee.title')}</h3>
                <div className="grid grid-cols-3 gap-4 text-center mb-6">
                  <div className="bg-white dark:bg-slate-800 p-4 rounded-xl">
                    <div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-1">24h</div>
                    <div className="text-xs text-muted-foreground">{t('why.guarantee.general')}</div>
                  </div>
                  <div className="bg-white dark:bg-slate-800 p-4 rounded-xl">
                    <div className="text-3xl font-bold text-green-600 dark:text-green-400 mb-1">4h</div>
                    <div className="text-xs text-muted-foreground">{t('why.guarantee.urgent')}</div>
                  </div>
                  <div className="bg-white dark:bg-slate-800 p-4 rounded-xl">
                    <div className="text-3xl font-bold text-purple-600 dark:text-purple-400 mb-1">100%</div>
                    <div className="text-xs text-muted-foreground">{t('why.guarantee.satisfaction')}</div>
                  </div>
                </div>
