...
const routes: Route[] = [
  ...
  { path: '/help/seo-tools/ai-assistant', priority: 0.5, changeFrequency: 'monthly' },
  { path: '/help/seo-tools/seo-audit', priority: 0.5, changeFrequency: 'monthly' },
  { path: '/help/seo-tools/site-crawler', priority: 0.5, changeFrequency: 'monthly' },
