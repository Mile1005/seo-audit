      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
          ...
          <div className="container mx-auto px-4 py-16 relative z-10">
            ...
            >
              ...
              <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                Deep-dive into your website's technical SEO health. Crawl up to 50 pages and uncover
                issues that impact your rankings.
              </p>
            </motion.div>
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        Enter any URL format - we'll handle the rest
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        onKeyDown={(e) =>
                          e.key === "Enter" && !crawling && url.trim() && handleCrawl()
                        }
                        disabled={crawling}
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-gray-300">
                            Crawl up to{" "}
                            <span className="text-white font-semibold">{maxPages} pages</span>
                          </span>
                        </div>
                        <ChevronDown
                          className={`w-5 h-5 text-gray-400 transition-transform ${showPageOptions ? "rotate-180" : ""}`}
                        />
                      </button>
        ...
        <AnimatePresence>
          {crawling && (
            ...
            >
              <AnimatedCrawlVisualization
                url={normalizeUrl(url.trim()) || url}
                maxPages={maxPages}
              />
            </motion.div>
          )}
            ...
            >
              ...
              <div className="text-center mb-12">
                ...
                <p className="text-gray-400">
                  Crawled {results.stats.totalPages} pages in{" "}
                  {((results.stats.avgLoadTimeMs * results.stats.totalPages) / 1000).toFixed(1)}s
                </p>
              </div>
              ...
              >
                <div
                  className={`relative overflow-hidden rounded-2xl border bg-gradient-to-br ${getScoreBg(calculateScore(results))} p-8 text-center`}
                >
                  <div className="relative z-10">
                    <div
                      className={`text-6xl font-bold mb-2 ${getScoreColor(calculateScore(results))}`}
                    >
                ...
                {[
                  {
                    icon: FileText,
                    label: "Total Pages",
                    value: results.stats.totalPages,
                    color: "blue",
                  },
                  {
                    icon: CheckCircle,
                    label: "Successful",
                    value: results.stats.successful,
                    color: "green",
                  },
                  {
                    icon: AlertTriangle,
                    label: "Issues Found",
                    value: results.stats.failed,
                    color: "red",
                  },
                  {
                    icon: Zap,
                    label: "Avg Load Time",
                    value: `${results.stats.avgLoadTimeMs}ms`,
                    color: "orange",
                  },
                ].map((stat, i) => (
                  <motion.div
                ...
                >
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-4 rounded-lg bg-slate-700/30">
                      ...
                      <Badge
                        variant={results.robots === "present" ? "default" : "destructive"}
                        className={
                          results.robots === "present"
                    ...
                    <div className="flex items-center justify-between p-4 rounded-lg bg-slate-700/30">
                      ...
                      <Badge
                        variant={results.sitemap === "present" ? "default" : "destructive"}
                        className={
                          results.sitemap === "present"
                            ? "bg-green-500/20 text-green-400 border-green-500/30"
                            : ""
                        }
                      >
                    ...
                    {[
                      {
                        ...
                        value: results.issuesSummary.missingTitles,
                        color: "red",
                      },
                      {
                        label: "Missing H1",
                        value: results.issuesSummary.missingH1,
                        color: "yellow",
                      },
                      {
                        label: "Missing Meta",
                        value: results.issuesSummary.missingMeta,
                        color: "orange",
                      },
                      {
                        label: "Images w/o Alt",
                        value: results.issuesSummary.imagesWithoutAlt,
                        color: "purple",
                      },
                    ].map((issue) => (
              ...
              >
                ...
                <p className="text-gray-400 mb-6 max-w-md mx-auto">
                  Unlock unlimited page crawls, scheduled monitoring, and advanced export options
                  with our Pro plan.
                </p>
                <Button
                  size="lg"
              ...
              {[
                {
                  icon: FileText,
                  title: "Meta Tags",
                  desc: "Title, description, and Open Graph tags",
                },
                {
                  icon: Code,
                  title: "HTML Structure",
                  desc: "Headings, semantic markup, and accessibility",
                },
                {
                  icon: Link,
                  title: "Link Analysis",
                  desc: "Internal links, broken links, and redirects",
                },
                {
                  icon: ImageIcon,
                  title: "Image Optimization",
                  desc: "Alt text, file sizes, and formats",
                },
