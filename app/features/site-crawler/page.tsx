...
import { Globe, Search, AlertTriangle, CheckCircle, FileText, Zap, Loader2 } from 'lucide-react'
        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <Card className="mb-12 bg-white/5 border-white/10">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400">Enter your website URL - any format accepted (example.com, www.example.com, https://example.com)</CardDescription>
            </CardHeader>
          ...
          <AnimatePresence>
            {results && (
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                ...
                <h2 className="text-3xl font-bold text-center">Crawl Results for {new URL(results.pages[0]?.url || url).hostname}</h2>
