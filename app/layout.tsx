...
export const metadata: Metadata = {
  ...
  description:
    "Get actionable SEO insights that boost rankings and drive organic traffic. Join 1,000+ marketers using our AI-powered audits to identify critical issues in minutes.",
  ...
  openGraph: {
    ...
    description:
      "Get actionable SEO insights that boost rankings and drive organic traffic in minutes.",
...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  const organizationSchema = {
    ...
    founder: {
      ...
      sameAs: ["https://x.com/MILE100EV", "https://github.com/Mile1005"],
    },
    sameAs: [
  ...
  const softwareApplicationSchema = {
    ...
    description:
      "AI-powered SEO audit platform that helps marketers and businesses identify critical SEO issues in minutes. Get actionable insights to boost rankings and drive organic traffic with comprehensive website audits.",
    offers: {
      "@type": "Offer",
      price: "0",
      priceCurrency: "USD",
