...
export default function CaseStudiesPage() {
  ...
  const caseStudies = [
    ...
    },
    {
      ...
      results: [t("cases.peak.results.0"), t("cases.peak.results.1"), t("cases.peak.results.2")],
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            <div className="grid lg:grid-cols-2 gap-8">
              {caseStudies.map((study) => (
                <div
                  key={study.id}
                  className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-2xl overflow-hidden shadow-2xl"
                >
                  <div className="p-8">
