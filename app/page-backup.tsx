...
const FeaturesShowcase = dynamic(() => import("@/components/features/features-showcase").then(mod => ({ default: mod.FeaturesShowcase })), {
...
const InteractiveDemo = dynamic(() => import("@/components/demo/interactive-demo").then(mod => ({ default: mod.InteractiveDemo })), {
...
const TestimonialsCarousel = dynamic(() => import("@/components/testimonials/testimonials-carousel").then(mod => ({ default: mod.TestimonialsCarousel })), {
...
const PricingCards = dynamic(() => import("@/components/pricing/pricing-cards").then(mod => ({ default: mod.PricingCards })), {
