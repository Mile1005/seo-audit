          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                {(["qualifiedLeads", "brandAwareness", "costPerLead", "salesCycle"] as const).map(
                  (key) => {
              ...
              <div className="bg-slate-800/50 rounded-xl p-8 border border-slate-700">
                <div className="text-center">
                  <div className="text-4xl font-bold text-red-400 mb-2">
                    {t("challengeMetrics.costPerLead.value")}
                  </div>
                  <div className="text-gray-400 mb-4">
                    {t("challengeMetrics.costPerLead.label")}
                  </div>
                  <div className="text-4xl font-bold text-red-400 mb-2">
                    {t("challengeMetrics.salesCycle.value")}
                  </div>
      ...
      <section className="py-20 bg-slate-900">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {(["keywordResearch", "contentStrategy", "technicalSeo", "leadNurturing"] as const).map(
              (key) => {
                  ...
                  {([0, 1, 2] as const).map((index) => (
                    <li key={index} className="flex items-center gap-3">
                      ...
                      <span className="text-gray-300">
                        {t(`contentPerformance.items.${index}`)}
                      </span>
                    </li>
                  ))}
                </ul>
                ...
                <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700 hover:border-slate-600 transition-all duration-300">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">
                        {t("relatedCaseStudies.digitalGrowth.category")}
                      </p>
                    </div>
                  </div>
                  <p className="text-gray-400 text-sm mb-4">
