...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: generateAlternates('/case-studies/techflow-solutions', locale as Locale)
  }
}
...
export default async function TechFlowSolutionsCaseStudy({ params }: { params: { locale: string } }) {
  ...
  const results = [
    ...
    {
      metric: t('results.leadQuality.metric'),
      value: t('results.leadQuality.value'),
      description: t('results.leadQuality.description'),
      icon: Users
    },
    {
      metric: t('results.costPerLead.metric'),
      value: t('results.costPerLead.value'),
      description: t('results.costPerLead.description'),
      icon: BarChart3
    }
  ]
  ...
  const caseStudySchema = generateCaseStudySchema({
    title: `${t('name')}: ${t('title')} - ${t('results.traffic.value')} Traffic Increase`,
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Breadcrumbs
              items={[
                ...
                { name: t('name'), url: 'https://www.aiseoturbo.com/case-studies/techflow-solutions' }
              ]}
              darkMode={true}
              className="mb-8"
            />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-slate-800/50 rounded-xl p-8 border border-slate-700">
                <div className="text-center">
                  ...
                  <div className="text-gray-400 mb-4">{t('challengeStats.pages')}</div>
                  <div className="text-4xl font-bold text-red-400 mb-2">200+</div>
                  <div className="text-gray-400">{t('challengeStats.issues')}</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="bg-slate-800/50 rounded-xl p-8 border border-slate-700">
                <h3 className="text-xl font-bold text-white mb-4">{t('technicalCategories.performance.title')}</h3>
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
                    <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" aria-hidden="true" />
                    <span className="text-gray-300">{t('technicalCategories.performance.items.0')}</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" aria-hidden="true" />
                    <span className="text-gray-300">{t('technicalCategories.performance.items.1')}</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" aria-hidden="true" />
                    <span className="text-gray-300">{t('technicalCategories.performance.items.2')}</span>
                  </li>
                </ul>
              </div>

              <div className="bg-slate-800/50 rounded-xl p-8 border border-slate-700">
                <h3 className="text-xl font-bold text-white mb-4">{t('technicalCategories.infrastructure.title')}</h3>
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
                    <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" aria-hidden="true" />
                    <span className="text-gray-300">{t('technicalCategories.infrastructure.items.0')}</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" aria-hidden="true" />
                    <span className="text-gray-300">{t('technicalCategories.infrastructure.items.1')}</span>
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" aria-hidden="true" />
                    <span className="text-gray-300">{t('technicalCategories.infrastructure.items.2')}</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-900/20 to-purple-900/20 rounded-xl p-8 border border-blue-500/20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <div className="text-gray-400">{t('roiMetrics.overallRoi')}</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-green-400 mb-2">$2.3M</div>
                  <div className="text-gray-400">{t('roiMetrics.revenue')}</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-purple-400 mb-2">4 months</div>
                  <div className="text-gray-400">{t('roiMetrics.payback')}</div>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-white group-hover:text-green-400 transition-colors">
                        {t('relatedCases.digitalGrowthAgency.title')}
                      </h3>
                      <p className="text-gray-400 text-sm">{t('relatedCases.digitalGrowthAgency.subtitle')}</p>
                    </div>
                  </div>
                  <p className="text-gray-400 text-sm mb-4">
                    {t('relatedCases.digitalGrowthAgency.description')}
                  </p>
                  <div className="flex items-center text-green-400 text-sm font-medium">
                    {t('relatedCases.digitalGrowthAgency.cta')}
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-white group-hover:text-purple-400 transition-colors">
                        {t('relatedCases.cloudsyncPro.title')}
                      </h3>
                      <p className="text-gray-400 text-sm">{t('relatedCases.cloudsyncPro.subtitle')}</p>
                    </div>
                  </div>
                  <p className="text-gray-400 text-sm mb-4">
                    {t('relatedCases.cloudsyncPro.description')}
                  </p>
                  <div className="flex items-center text-purple-400 text-sm font-medium">
                    {t('relatedCases.cloudsyncPro.cta')}
                    <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" aria-hidden="true" />
                  </div>
                </div>
              </Link>
