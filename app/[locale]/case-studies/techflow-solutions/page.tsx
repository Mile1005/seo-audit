...
export default async function TechFlowSolutionsCaseStudy({
  params,
}: {
  ...
  const t = await getTranslations({
    ...
    namespace: "caseStudies.techflowSolutions",
  });
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="bg-slate-800/50 rounded-xl p-8 border border-slate-700">
                <h3 className="text-xl font-bold text-white mb-4">
                  {t("technicalCategories.performance.title")}
                </h3>
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
                    ...
                    <span className="text-gray-300">
                      {t("technicalCategories.performance.items.0")}
                    </span>
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle
                    ...
                    />
                    <span className="text-gray-300">
                      {t("technicalCategories.performance.items.1")}
                    </span>
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle
                    ...
                    />
                    <span className="text-gray-300">
                      {t("technicalCategories.performance.items.2")}
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-slate-800/50 rounded-xl p-8 border border-slate-700">
                <h3 className="text-xl font-bold text-white mb-4">
                  {t("technicalCategories.infrastructure.title")}
                </h3>
                <ul className="space-y-3">
                  <li className="flex items-center gap-3">
                    <CheckCircle
                    ...
                    />
                    <span className="text-gray-300">
                      {t("technicalCategories.infrastructure.items.0")}
                    </span>
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle
                    ...
                    />
                    <span className="text-gray-300">
                      {t("technicalCategories.infrastructure.items.1")}
                    </span>
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle
                    ...
                    />
                    <span className="text-gray-300">
                      {t("technicalCategories.infrastructure.items.2")}
                    </span>
                  </li>
                </ul>
              </div>
      ...
      <section className="py-20 bg-slate-900">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-white mb-6">{t("relatedTitle")}</h2>
            <p className="text-gray-400 mb-12">{t("relatedSubtitle")}</p>
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">
                        {t("relatedCases.digitalGrowthAgency.subtitle")}
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700 hover:border-slate-600 transition-all duration-300">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">
                        {t("relatedCases.cloudsyncPro.subtitle")}
                      </p>
                    </div>
                  </div>
                  <p className="text-gray-400 text-sm mb-4">
