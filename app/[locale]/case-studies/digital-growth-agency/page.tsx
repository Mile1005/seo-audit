          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Breadcrumbs
              items={[
                ...
                { name: t('name'), url: 'https://www.aiseoturbo.com/case-studies/digital-growth-agency' }
              ]}
              darkMode={true}
              className="mb-8"
            />
            ...
            <div className="text-center mb-12">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                {(['organicTraffic', 'keywordRankings', 'clientRetention', 'timeEfficiency'] as const).map((key) => {
                  ...
                  return (
                    <div key={key} className="bg-slate-800/50 rounded-lg p-4 border border-slate-700">
                      ...
                      <div className="text-2xl font-bold text-green-400 mb-1">{t(`results.${key}.value`)}</div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-slate-800/50 rounded-xl p-8 border border-slate-700">
                <div className="text-center">
                  <div className="text-4xl font-bold text-red-400 mb-2">{t('challengeMetrics.hoursPerClient.value')}</div>
                  <div className="text-gray-400 mb-4">{t('challengeMetrics.hoursPerClient.label')}</div>
                  <div className="text-4xl font-bold text-red-400 mb-2">{t('challengeMetrics.churnRate.value')}</div>
      ...
      <section className="py-20 bg-slate-900">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {(['aiAudit', 'competitorAnalysis', 'contentOptimization', 'workflowAutomation'] as const).map((key) => {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              ...
              <div className="bg-slate-800/50 rounded-xl p-8 border border-slate-700">
                <h3 className="text-xl font-bold text-white mb-4">{t('operationalEfficiency.title')}</h3>
                <ul className="space-y-3">
                  {([0, 1, 2] as const).map((index) => (
                    <li key={index} className="flex items-center gap-3">
                      <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" aria-hidden="true" />
                      <span className="text-gray-300">{t(`operationalEfficiency.items.${index}`)}</span>
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {(['overallRoi', 'revenueIncrease', 'paybackPeriod'] as const).map((key) => (
                  <div key={key} className="text-center">
                    <div className="text-3xl font-bold text-green-400 mb-2">{t(`roiMetrics.${key}.value`)}</div>
                ...
                <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700 hover:border-slate-600 transition-all duration-300">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">{t('relatedCaseStudies.stylecraft.category')}</p>
                    </div>
                  </div>
                  <p className="text-gray-400 text-sm mb-4">
