...
export default async function PeakPerformanceCaseStudy({ params }: { params: { locale: string } }) {
  const t = await getTranslations({
    ...
    namespace: "caseStudies.peakPerformance",
  });
  ...
  const caseStudySchema = generateCaseStudySchema({
    ...
    description:
      "Comprehensive local SEO case study showing how Peak Performance became the dominant local service provider through strategic local optimization.",
    ...
    reviewText:
      "We went from being invisible to dominating our local market. AI SEO Turbo's local SEO insights were game-changing. We're now the first result that customers see when they search for our services, and our phone hasn't stopped ringing.",
  });
