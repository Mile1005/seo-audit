...
export default function PeakPerformanceCaseStudy() {
  ...
  // Challenge Points
  const challengePoints = t.raw('challengePoints') as string[]
      ...
      <section className="py-16 bg-gradient-to-b from-slate-900 to-slate-950">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <Breadcrumbs
              items={[
                { name: tBreadcrumbs('caseStudies'), url: '/case-studies' },
                { name: t('name'), url: '/case-studies/peak-performance' }
              ]}
              darkMode={true}
              className="mb-8"
            />
                ...
                <div className="flex items-center justify-center gap-4">
                  <div className="w-12 h-12 bg-orange-500/10 rounded-full flex items-center justify-center">
                    <span className="text-orange-400 font-bold">
                      {t('testimonial.author').split(' ').map(n => n[0]).join('')}
                    </span>
                  </div>
