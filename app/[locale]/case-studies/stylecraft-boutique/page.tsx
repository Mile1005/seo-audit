...
export default async function StyleCraftBoutiqueCaseStudy({
  params,
}: {
  ...
  const t = await getTranslations({
    ...
    namespace: "caseStudies.stylecraftBoutique",
  });
  ...
  const caseStudySchema = generateCaseStudySchema({
    ...
    description:
      "Comprehensive e-commerce SEO case study showing how StyleCraft Boutique transformed their online retail performance with AI-powered optimization.",
    ...
    reviewText:
      "Our online sales have never been better. AI SEO Turbo helped us understand exactly what our customers were searching for. We went from being a local boutique to a digital retail leader, and our revenue reflects that transformation.",
  });
                  ...
                  {[0, 1, 2].map((index) => (
                    <li key={index} className="flex items-center gap-3">
                      ...
                      <span className="text-gray-300">
                        {t(`productPerformance.items.${index}`)}
                      </span>
                    </li>
                  ))}
                </ul>
                ...
                <ul className="space-y-3">
                  {[0, 1, 2].map((index) => (
                    <li key={index} className="flex items-center gap-3">
                      ...
                      />
                      <span className="text-gray-300">
                        {t(`technicalImprovements.items.${index}`)}
                      </span>
                    </li>
                  ))}
                </ul>
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">
                        {t("relatedCaseStudies.gearhubPro.category")}
                      </p>
                    </div>
                  </div>
