          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
                {tHero('title')} <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500">{tHero('titleHighlight')}</span> {tHero('titleEnd')}
              </h1>
          ...
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                {tFeatures('title')} <span className="text-purple-400">{tFeatures('titleHighlight')}</span>
              </h2>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-16">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-3">{tCards('technicalAnalysis.title')}</h3>
                <p className="text-gray-400 text-sm">
                  {tCards('technicalAnalysis.description')}
                </p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-3">{tCards('competitorIntelligence.title')}</h3>
                <p className="text-gray-400 text-sm">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-3">{tCards('priorityScoring.title')}</h3>
                <p className="text-gray-400 text-sm">
                  {tCards('priorityScoring.description')}
                </p>
              </motion.div>
            </div>
            ...
            <div className="bg-slate-800/50 border border-slate-700 rounded-2xl p-8 mb-12">
              <h2 className="text-2xl font-bold text-white mb-6 text-center">{tCoverage('title')}</h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="text-white font-semibold mb-1">{tCoverage('structure.title')}</h3>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="text-white font-semibold mb-1">{tCoverage('content.title')}</h3>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="text-white font-semibold mb-1">{tCoverage('performance.title')}</h3>
                      <p className="text-gray-400 text-sm">{tCoverage('performance.description')}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="text-white font-semibold mb-1">{tCoverage('security.title')}</h3>
