          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6">
                {t('hero.title')} <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">{t('hero.titleHighlight')}</span>{t('hero.titleEnd')}
              </h1>
              ...
              {helpCategories.map((category, index) => (
                ...
                >
                  <div className="mb-6">
                    ...
                    <p className="text-gray-400 mb-6">{t(`categories.${category.key}.description`)}</p>
                  </div>
                    ...
                    {category.articles.slice(0, 4).map((article, articleIndex) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-xs text-gray-500">{t(`categories.${category.key}.articles.${article.key}.time`)}</span>
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-gray-500">{t(`contact.${option.key}.availability`)}</span>
                  ...
                  {[
                    ...
                    <div key={index} className="flex items-center justify-between p-3 bg-slate-900/50 rounded-lg">
                      ...
                      <div className="text-right">
                        <div className="text-green-400 text-sm font-medium">{t('status.operational')}</div>
                        <div className="text-gray-500 text-xs">{t('status.uptime', { percent: service.uptime })}</div>
                      </div>
                    </div>
                  ))}
                </div>
