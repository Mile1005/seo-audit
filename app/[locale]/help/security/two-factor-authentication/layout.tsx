...
export const metadata: Metadata = {
  ...
  description:
    "Set up and manage two-factor authentication (2FA) for your AI SEO Turbo account. Learn to enable 2FA, use authenticator apps, and secure your SEO data.",
  keywords: [
...
export default function TwoFactorAuthLayout({ children }: { children: React.ReactNode }) {
  return children;
}
