...
export const metadata: Metadata = {
  ...
  description:
    "Essential security best practices for AI SEO Turbo users. Learn to protect your account, use strong passwords, enable 2FA, and secure your SEO data.",
  keywords: [
...
export default function BestPracticesLayout({ children }: { children: React.ReactNode }) {
  return children;
}
