...
export const metadata: Metadata = {
  ...
  description:
    "Get started with AI SEO Turbo quickly. Learn dashboard setup, run your first audit, understand SEO scores, and optimize your website performance.",
  keywords: [
    "getting started",
    "SEO setup",
    "first audit",
  ...
  alternates: {
    canonical: "https://www.aiseoturbo.com/help/getting-started",
  },
  openGraph: {
    images: ["/logo.png"],
