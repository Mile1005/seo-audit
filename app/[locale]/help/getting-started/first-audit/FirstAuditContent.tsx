...
export default function FirstAuditContent() {
  ...
  const howToSchema = generateHowToSchema({
    ...
    description:
      "Run Your First Audit. Step-by-step guide to analyzing your site, finding errors, and improving health scores with AI SEO Turbo. Start now.",
