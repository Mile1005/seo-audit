...
export const metadata: Metadata = {
  ...
  description:
    "Step-by-step guide to running your first SEO audit with AI SEO Turbo. Learn to analyze websites, configure settings, and get SEO recommendations.",
  keywords: [
    "first SEO audit",
    "website analysis",
    "SEO audit guide",
...
export default function FirstAuditLayout({ children }: { children: React.ReactNode }) {
  return children;
}
