          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <Breadcrumbs
              items={[
                ...
                {
                  name: t("breadcrumb.dashboardSetup"),
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="bg-slate-900/50 border border-slate-600 rounded-lg p-4 mb-4">
                        ...
                        <p className="text-gray-300 text-sm mb-0">{t("steps.1.tip.description")}</p>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-3">
                        {t.raw("steps.3.notifications").map((notification: any, index: number) => (
                          ...
                          >
                            <CheckCircle
                              className={`w-5 h-5 mt-0.5 ${index === 0 ? "text-green-400" : index === 1 ? "text-yellow-400" : "text-blue-400"}`}
                              aria-hidden="true"
                            />
                            <div>
