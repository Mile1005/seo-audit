...
export default function SettingsPage() {
  ...
  async function changePassword() {
    if (!pwd.current || !pwd.next || pwd.next !== pwd.confirm)
      return toast.error("Fill all password fields correctly");
    setLoading(true);
    try {
              ...
              <div className="bg-slate-50 p-6 rounded-lg border border-slate-200 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-600 mt-1 max-w-md">
                    Your account uses Google sign in. Password management is handled by your Google
                    Account.
                  </p>
                </div>
