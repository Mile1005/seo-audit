...
export async function generateMetadata({
  ...
  return generateSEOMeta({
    ...
    description:
      "Master content SEO with keyword research, user intent optimization, and structure best practices to create content that ranks and converts.",
...
export default async function ContentSEOContentPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const t = await getTranslations({
    locale,
    namespace: "blog.contentSEOCreatingSearchFriendlyContent",
  });
