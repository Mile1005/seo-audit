...
export async function generateMetadata({
  ...
  return generateSEOMeta({
    ...
    description:
      "Master technical SEO in 2025 with our complete guide covering site speed, mobile-first indexing, structured data, crawlability, and best practices.",
...
export default async function TechnicalSEO2025Page({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
