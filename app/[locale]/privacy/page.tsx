    ...
    <MainLayout>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 overflow-x-hidden">
        ...
        <div className="pt-8 pb-4 px-4 sm:px-6 lg:px-8">
          <Breadcrumbs
            items={[{ name: "Privacy Policy", url: "https://www.aiseoturbo.com/privacy" }]}
            includeHome={true}
          />
        </div>
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl relative z-10">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-4">{t("hero.description")}</p>
                  ...
                  <div className="pl-14 space-y-4 text-muted-foreground">
                    ...
                    <div className="bg-muted/50 rounded-lg p-4 border border-border/50">
                      <h4 className="font-semibold text-foreground mb-2">
                        {t("sections.informationWeCollect.dataTypes.title")}
                      </h4>
                ...
                >
                  ...
                  <div className="pl-14 space-y-4 text-muted-foreground">
                    ...
                    <div className="grid gap-4">
                      <div className="bg-muted/50 rounded-lg p-4 border border-border/50">
                        <h4 className="font-semibold text-foreground mb-2">
                          {t("sections.howWeUse.serviceProvision.title")}
                        </h4>
                        <p>{t("sections.howWeUse.serviceProvision.description")}</p>
                      </div>
                      <div className="bg-muted/50 rounded-lg p-4 border border-border/50">
                        <h4 className="font-semibold text-foreground mb-2">
                          {t("sections.howWeUse.communication.title")}
                        </h4>
                        <p>{t("sections.howWeUse.communication.description")}</p>
                      </div>
                      <div className="bg-muted/50 rounded-lg p-4 border border-border/50">
                        <h4 className="font-semibold text-foreground mb-2">
                          {t("sections.howWeUse.improvement.title")}
                        </h4>
                ...
                >
                  ...
                  <div className="pl-14 space-y-4 text-muted-foreground">
                    ...
                    <div className="space-y-3">
                      {[
                        {
                          title: t("sections.yourRights.rights.access.title"),
                          description: t("sections.yourRights.rights.access.description"),
                        },
                        {
                          title: t("sections.yourRights.rights.correction.title"),
                          description: t("sections.yourRights.rights.correction.description"),
                        },
                        {
                          title: t("sections.yourRights.rights.deletion.title"),
                          description: t("sections.yourRights.rights.deletion.description"),
                        },
                        {
                          title: t("sections.yourRights.rights.portability.title"),
                          description: t("sections.yourRights.rights.portability.description"),
                        },
                      ].map((right, index) => (
                  ...
                  <div className="pl-14 space-y-4 text-muted-foreground">
                    ...
                    <div className="bg-muted/50 rounded-lg p-6 border border-border/50">
                      <div className="grid md:grid-cols-2 gap-4">
                        <div>
                          <h4 className="font-semibold text-foreground mb-2">
                            {t("sections.contactUs.email.title")}
                          </h4>
                          <a
                        ...
                        <div>
                          <h4 className="font-semibold text-foreground mb-2">
                            {t("sections.contactUs.responseTime.title")}
                          </h4>
            ...
            >
              <div className="space-y-12">
                ...
                >
                  ...
                  <div className="pl-14 space-y-4 text-muted-foreground">
                    <p>{t("sections.privacyInSeoTools.description")}</p>
                  </div>
                </motion.section>
                ...
                >
                  ...
                  <div className="pl-14 space-y-4 text-muted-foreground">
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      <li>
                        <strong>{t("sections.privacyCommitments.dataMinimization.title")}:</strong>{" "}
                        {t("sections.privacyCommitments.dataMinimization.description")}
                      </li>
                      <li>
                        <strong>{t("sections.privacyCommitments.purposeLimitation.title")}:</strong>{" "}
                        {t("sections.privacyCommitments.purposeLimitation.description")}
                      </li>
                      <li>
                        <strong>{t("sections.privacyCommitments.securityFirst.title")}:</strong>{" "}
                        {t("sections.privacyCommitments.securityFirst.description")}
                      </li>
                      <li>
                        <strong>{t("sections.privacyCommitments.transparency.title")}:</strong>{" "}
                        {t("sections.privacyCommitments.transparency.description")}
                      </li>
                      <li>
                        <strong>{t("sections.privacyCommitments.userControl.title")}:</strong>{" "}
                        {t("sections.privacyCommitments.userControl.description")}
                      </li>
                    </ul>
                  </div>
                </motion.section>
                ...
                >
                  ...
                  <div className="pl-14 space-y-4 text-muted-foreground">
                    <p>{t("sections.dataProcessing.description")}</p>
                    <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                >
                  ...
                  <div className="pl-14 space-y-4 text-muted-foreground">
                    <p>{t("sections.securityMeasures.description")}</p>
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      <li>
                        <strong>{t("sections.securityMeasures.measures.encryption.title")}:</strong>{" "}
                        {t("sections.securityMeasures.measures.encryption.description")}
                      </li>
                      <li>
                        <strong>{t("sections.securityMeasures.measures.zeroTrust.title")}:</strong>{" "}
                        {t("sections.securityMeasures.measures.zeroTrust.description")}
                      </li>
                      <li>
                        <strong>{t("sections.securityMeasures.measures.audits.title")}:</strong>{" "}
                        {t("sections.securityMeasures.measures.audits.description")}
                      </li>
                      <li>
                        <strong>{t("sections.securityMeasures.measures.incident.title")}:</strong>{" "}
                        {t("sections.securityMeasures.measures.incident.description")}
                      </li>
                      <li>
                        <strong>{t("sections.securityMeasures.measures.residency.title")}:</strong>{" "}
                        {t("sections.securityMeasures.measures.residency.description")}
                      </li>
                    </ul>
                  </div>
                </motion.section>
                ...
                >
                  ...
                  <div className="pl-14 space-y-4 text-muted-foreground">
                    <p>{t("sections.compliance.description")}</p>
                  </div>
                </motion.section>
              </div>
            </motion.div>
