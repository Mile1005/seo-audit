...
export default function AboutPage() {
  ...
  const aboutSchema = generateAboutPageSchema({
    ...
    description:
      "AI-powered SEO audit platform helping businesses optimize their websites for better search engine rankings. We democratize SEO insights through cutting-edge AI technology.",
              ...
              <div className="bg-slate-50 dark:bg-slate-800/50 p-8 rounded-2xl">
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <p className="text-muted-foreground">{tMission("description")}</p>
                  </div>
                  <div>
                    <h3 className="text-xl font-semibold text-foreground mb-3">
                      {tVision("title")}
                    </h3>
                    <p className="text-muted-foreground">{tVision("description")}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg mx-auto text-muted-foreground">
                ...
                <p className="text-lg leading-relaxed mb-6">{tExpertise("ai.description")}</p>
                ...
                <p className="text-lg leading-relaxed">{tExpertise("track.description")}</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="prose prose-lg mx-auto text-muted-foreground mb-8">
                <p className="text-lg leading-relaxed">{tTeam("description")}</p>
              </div>
