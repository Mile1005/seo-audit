...
export const metadata: Metadata = {
  ...
  description: 'Step-by-step guide to running your first SEO audit with AI SEO Turbo. Learn to analyze websites, configure settings, and get actionable SEO recommendations.',
