...
export const metadata: Metadata = {
  ...
  description: 'Master the AI assistant feature in AI SEO Turbo. Learn best practices for getting actionable SEO recommendations, content optimization, and automated insights.',
