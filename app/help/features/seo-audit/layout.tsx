...
export const metadata: Metadata = {
  ...
  description: 'Complete walkthrough of SEO audits with AI SEO Turbo. Learn to analyze websites, identify issues, and get actionable recommendations for better rankings.',
