          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-gray-400 mb-8">
                Learn about our security measures, privacy policies, data protection practices, and
                how we keep your information safe and compliant.
              </p>
            ...
            <div className="space-y-12">
              ...
              <div>
                ...
                <p className="text-gray-300 text-lg">
                  At AI SEO Turbo, security and privacy are fundamental to everything we do. We
                  employ industry-leading security measures and comply with global privacy
                  regulations to protect your data and ensure your trust.
                </p>
              </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-300 text-sm mb-3">
                          Add an extra layer of security to your account with 2FA. Learn how to set
                          it up and manage your security preferences.
                        </p>
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-300 text-sm mb-3">
                          Control your privacy preferences, manage data sharing settings, and
                          understand how your information is used and protected.
                        </p>
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-300 text-sm mb-3">
                          Learn essential security practices for keeping your account safe,
                          including password management and account protection tips.
                        </p>
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-300 text-sm mb-3">
                          Understanding your rights under GDPR, how we comply with data protection
                          regulations, and how to manage your personal data.
                        </p>
                ...
                <div className="space-y-4">
                  <div className="bg-slate-800/50 border border-slate-700/50 rounded-lg p-6">
                    ...
                    <p className="text-gray-300 mb-4">
                      ...
                      encryption protocols. Your sensitive information is always protected.
                    </p>
                  </div>
                  ...
                  <div className="bg-slate-800/50 border border-slate-700/50 rounded-lg p-6">
                    ...
                    <p className="text-gray-300 mb-4">
                      We maintain compliance with SOC 2, GDPR, CCPA, and other global privacy and
                      security standards.
                    </p>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-gray-300 text-sm">
                      Strict access controls and regular security monitoring
                    </p>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-gray-300 text-sm">
                      Regular audits and compliance with global standards
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border border-indigo-500/20 rounded-lg p-8">
                <div className="text-center">
                  ...
                  <p className="text-gray-300 mb-6">
                    If you have questions about security, privacy, or suspect any unusual activity
                    on your account, our security team is here to help immediately.
                  </p>
