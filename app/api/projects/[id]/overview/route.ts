...
export async function GET(
  ...
  try {
    ...
    const overview = {
      ...
      recentActivity: {
        keywords: [
          { id: '1', keyword: 'seo audit tool', status: 'ACTIVE', createdAt: new Date().toISOString() },
          { id: '2', keyword: 'website analysis', status: 'ACTIVE', createdAt: new Date().toISOString() },
          { id: '3', keyword: 'free seo checker', status: 'ACTIVE', createdAt: new Date().toISOString() }
        ],
        audits: [
          { id: '1', url: 'https://aiseoturbo.com', status: 'COMPLETED', score: 87, createdAt: new Date().toISOString() },
          { id: '2', url: 'https://aiseoturbo.com/pricing', status: 'COMPLETED', score: 92, createdAt: new Date().toISOString() }
        ]
      },
      trends: {
