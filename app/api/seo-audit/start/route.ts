      ...
      try {
          ...
          if (auditRunModel) {
            auditRunModel
              .update({
                ...
                data: {
                  result: {
                    progress: { stage: "fetching", progress: 10, message: "Fetching page HTML" },
                  },
                },
              })
              .catch(() => {});
        ...
        try {
          ...
          if ((err as any)?.name === "AbortError") {
            throw new Error(
              `Site took too long to respond (>${Math.round(FETCH_TIMEOUT_MS / 1000)}s). Try again or test a different URL.`
            );
          }
          throw err;
        } finally {
          ...
          if (auditRunModel) {
            auditRunModel
              .update({
                ...
                data: {
                  result: {
                    progress: { stage: "saving", progress: 90, message: "Finalizing results" },
                  },
                },
              })
              .catch(() => {});
        ...
        const unified = buildUnifiedResult({
          auditId,
          url: normalizedUrl,
          audit,
            ...
            auditRunModel
              .update({
                ...
                data: {
                  status: "completed",
                  score: unified.score,
                  completedAt: new Date(unified.timestamp),
                  result: unified as unknown as any,
                },
              })
              .catch(() => {});
          }
            ...
            auditRunModel
              .update({
                ...
                data: {
                  ...
                  result: {
                    progress: { stage: "failed", message: err?.message || "Unknown error" },
                  },
                },
              })
              .catch(() => {});
