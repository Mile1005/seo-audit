...
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json(
      { error: 'Failed to fetch disavow files' },
      { status: 500 }
    )
  }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { projectId, includeAllToxic = true, specificBacklinkIds = [], customDomains = [] } = body
...
export async function PUT(request: NextRequest) {
  try {
    ...
    return NextResponse.json(
      { error: 'Failed to update disavow file' },
      { status: 500 }
    )
  }
}
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    return NextResponse.json(
      { error: 'Failed to delete disavow file' },
      { status: 500 }
    )
  }
}
