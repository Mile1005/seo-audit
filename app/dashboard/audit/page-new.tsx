      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-2 text-slate-600 dark:text-slate-400">
            Comprehensive SEO analysis with detailed performance, accessibility, and technical
            insights
          </p>
        </div>
        {currentAudit && (
                    ...
                    {currentAudit.contentAnalysis.keyword_density.length > 0 && (
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {currentAudit.contentAnalysis.keyword_density
                            .slice(0, 10)
                            .map((keyword, index) => (
                              <Badge key={index} variant="outline" className="text-xs">
              ...
              <Card className="border-slate-200 dark:border-slate-700">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="text-center">
                    <Card
                      className={`inline-block ${getScoreBg(currentAudit.accessibility.score)}`}
                    >
                      <CardContent className="p-6">
                        <div
                          className={`text-4xl font-bold ${getScoreColor(currentAudit.accessibility.score)}`}
                        >
            ...
            <TabsContent value="recommendations" className="space-y-6">
              <Card className="border-slate-200 dark:border-slate-700">
                <CardHeader>
                  ...
                  <CardDescription className="text-slate-600 dark:text-slate-400">
                    Prioritized recommendations with specific actions to improve your SEO
                    performance
                  </CardDescription>
                </CardHeader>
                <CardContent>
