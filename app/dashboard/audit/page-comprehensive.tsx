          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Completed on {new Date(result.timestamp).toLocaleString()} • Audit ID: {result.auditId}
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
                  ...
                  <div className="text-center">
                    <div className={`text-3xl font-bold ${getScoreColor(result.comprehensiveResults?.scores?.seo || 0)}`}>
                      {result.comprehensiveResults?.scores?.seo || 0}
                    </div>
                    <div className="text-sm text-muted-foreground">SEO</div>
                    <Progress value={result.comprehensiveResults?.scores?.seo || 0} className="mt-2 h-2" />
                  </div>
                  <div className="text-center">
                    <div className={`text-3xl font-bold ${getScoreColor(result.comprehensiveResults?.scores?.performance || 0)}`}>
                      {result.comprehensiveResults?.scores?.performance || 0}
                    </div>
                    <div className="text-sm text-muted-foreground">Performance</div>
                    <Progress value={result.comprehensiveResults?.scores?.performance || 0} className="mt-2 h-2" />
                  </div>
                  <div className="text-center">
                    <div className={`text-3xl font-bold ${getScoreColor(result.comprehensiveResults?.scores?.accessibility || 0)}`}>
                      {result.comprehensiveResults?.scores?.accessibility || 0}
                    </div>
                    <div className="text-sm text-muted-foreground">Accessibility</div>
                    <Progress value={result.comprehensiveResults?.scores?.accessibility || 0} className="mt-2 h-2" />
                  </div>
                  <div className="text-center">
                    <div className={`text-3xl font-bold ${getScoreColor(result.comprehensiveResults?.scores?.best_practices || 0)}`}>
                      {result.comprehensiveResults?.scores?.best_practices || 0}
                    </div>
                    <div className="text-sm text-muted-foreground">Best Practices</div>
                    <Progress value={result.comprehensiveResults?.scores?.best_practices || 0} className="mt-2 h-2" />
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Tabs defaultValue="overview" className="w-full">
              ...
              <TabsContent value="overview" className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <Card>
                    ...
                    <CardContent className="space-y-2">
                      ...
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium">{result.pageData.wordCount.toLocaleString()}</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span>Reading Time:</span>
                        <span className="font-medium">{result.comprehensiveResults?.stats?.reading_time_min || 0} min</span>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-2">
                      ...
                      <div className="flex justify-between text-sm">
                        ...
                        <span className={`font-medium ${result.pageData.imagesWithoutAlt > 0 ? 'text-red-500' : 'text-green-500'}`}>
                          {result.pageData.imagesWithoutAlt}
                        </span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span>Images Size:</span>
                        <span className="font-medium">{formatBytes(result.comprehensiveResults?.stats?.images_size || 0)}</span>
                      </div>
                    </CardContent>
                  </Card>
                      ...
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium">
                          {result.pageData.internalLinks > 0 ? 
                            (result.pageData.internalLinks / (result.pageData.internalLinks + result.pageData.externalLinks) * 100).toFixed(0) + '% internal'
                            : 'N/A'
                          }
                        </span>
                      </div>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-2">
                      ...
                      <div className="flex justify-between text-sm">
                        <span>Scripts:</span>
                        <span className="font-medium">{result.comprehensiveResults?.stats?.scripts_count || 0}</span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span>Text Ratio:</span>
                        <span className="font-medium">{((result.comprehensiveResults?.stats?.text_rate || 0) * 100).toFixed(1)}%</span>
                      </div>
                    </CardContent>
                  </Card>
                </div>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      <Label className="text-sm font-medium">Title Tag ({result.pageData.title.length} characters)</Label>
                      <p className="text-sm text-muted-foreground mt-1 p-2 bg-muted rounded">
                        {result.pageData.title || 'No title found'}
                      </p>
                      {result.pageData.title.length > 60 && (
                        <p className="text-xs text-yellow-600 mt-1">⚠️ Title is longer than recommended 60 characters</p>
                      )}
                    </div>
                    <div>
                      <Label className="text-sm font-medium">Meta Description ({result.pageData.metaDescription.length} characters)</Label>
                      <p className="text-sm text-muted-foreground mt-1 p-2 bg-muted rounded">
                        {result.pageData.metaDescription || 'No meta description found'}
                      </p>
                      {result.pageData.metaDescription.length > 160 && (
                        <p className="text-xs text-yellow-600 mt-1">⚠️ Meta description is longer than recommended 160 characters</p>
                      )}
                    </div>
                  </CardContent>
                </Card>
              ...
              <TabsContent value="core-web-vitals" className="space-y-6">
                  ...
                  {result.comprehensiveResults?.performance_metrics && (
                    <>
                      <Card>
                        ...
                        <CardContent>
                          <div className={`text-2xl font-bold ${getRatingColor(getCoreWebVitalRating('fcp', result.comprehensiveResults.performance_metrics.first_contentful_paint))}`}>
                            {result.comprehensiveResults.performance_metrics.first_contentful_paint.toFixed(1)}s
                          </div>
                          <Badge variant={getCoreWebVitalRating('fcp', result.comprehensiveResults.performance_metrics.first_contentful_paint) === 'good' ? 'default' : 
                                        getCoreWebVitalRating('fcp', result.comprehensiveResults.performance_metrics.first_contentful_paint) === 'needs-improvement' ? 'secondary' : 'destructive'}>
                            {getCoreWebVitalRating('fcp', result.comprehensiveResults.performance_metrics.first_contentful_paint)}
                          </Badge>
                      ...
                      <Card>
                        ...
                        <CardContent>
                          <div className={`text-2xl font-bold ${getRatingColor(getCoreWebVitalRating('lcp', result.comprehensiveResults.performance_metrics.largest_contentful_paint))}`}>
                            {result.comprehensiveResults.performance_metrics.largest_contentful_paint.toFixed(1)}s
                          </div>
                          <Badge variant={getCoreWebVitalRating('lcp', result.comprehensiveResults.performance_metrics.largest_contentful_paint) === 'good' ? 'default' : 
                                        getCoreWebVitalRating('lcp', result.comprehensiveResults.performance_metrics.largest_contentful_paint) === 'needs-improvement' ? 'secondary' : 'destructive'}>
                            {getCoreWebVitalRating('lcp', result.comprehensiveResults.performance_metrics.largest_contentful_paint)}
                          </Badge>
                          <p className="text-xs text-muted-foreground mt-2">
                      ...
                      <Card>
                        ...
                        <CardContent>
                          <div className={`text-2xl font-bold ${getRatingColor(getCoreWebVitalRating('cls', result.comprehensiveResults.performance_metrics.cumulative_layout_shift))}`}>
                            {result.comprehensiveResults.performance_metrics.cumulative_layout_shift.toFixed(3)}
                          </div>
                          <Badge variant={getCoreWebVitalRating('cls', result.comprehensiveResults.performance_metrics.cumulative_layout_shift) === 'good' ? 'default' : 
                                        getCoreWebVitalRating('cls', result.comprehensiveResults.performance_metrics.cumulative_layout_shift) === 'needs-improvement' ? 'secondary' : 'destructive'}>
                            {getCoreWebVitalRating('cls', result.comprehensiveResults.performance_metrics.cumulative_layout_shift)}
                          </Badge>
                          <p className="text-xs text-muted-foreground mt-2">
                      ...
                      <Card>
                        ...
                        <CardContent>
                          <div className={`text-2xl font-bold ${getRatingColor(getCoreWebVitalRating('tbt', result.comprehensiveResults.performance_metrics.total_blocking_time))}`}>
                            {result.comprehensiveResults.performance_metrics.total_blocking_time.toFixed(0)}ms
                          </div>
                          <Badge variant={getCoreWebVitalRating('tbt', result.comprehensiveResults.performance_metrics.total_blocking_time) === 'good' ? 'default' : 
                                        getCoreWebVitalRating('tbt', result.comprehensiveResults.performance_metrics.total_blocking_time) === 'needs-improvement' ? 'secondary' : 'destructive'}>
                            {getCoreWebVitalRating('tbt', result.comprehensiveResults.performance_metrics.total_blocking_time)}
                          </Badge>
                          <p className="text-xs text-muted-foreground mt-2">
                      ...
                      <Card>
                        ...
                        <CardContent>
                          <div className="text-2xl font-bold text-blue-500">
                            {result.comprehensiveResults.performance_metrics.time_to_interactive.toFixed(1)}s
                          </div>
                      ...
                      <Card>
                        ...
                        <CardContent>
                          <div className={`text-2xl font-bold ${getRatingColor(getCoreWebVitalRating('si', result.comprehensiveResults.performance_metrics.speed_index))}`}>
                            {result.comprehensiveResults.performance_metrics.speed_index.toFixed(1)}s
                          </div>
                          <Badge variant={getCoreWebVitalRating('si', result.comprehensiveResults.performance_metrics.speed_index) === 'good' ? 'default' : 
                                        getCoreWebVitalRating('si', result.comprehensiveResults.performance_metrics.speed_index) === 'needs-improvement' ? 'secondary' : 'destructive'}>
                            {getCoreWebVitalRating('si', result.comprehensiveResults.performance_metrics.speed_index)}
                          </Badge>
                          <p className="text-xs text-muted-foreground mt-2">
                ...
                {result.comprehensiveResults?.performance_opportunities && result.comprehensiveResults.performance_opportunities.length > 0 && (
                  <Card>
                    <CardHeader>
                      <CardTitle className="flex items-center gap-2">
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        {result.comprehensiveResults.performance_opportunities.slice(0, 5).map((opportunity, index) => (
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div>
                        <h4 className="font-medium mb-2">H1 Tags ({result.comprehensiveResults?.h_tags?.h1?.length || 0})</h4>
                      ...
                      <div>
                        <h4 className="font-medium mb-2">H2 Tags ({result.comprehensiveResults?.h_tags?.h2?.length || 0})</h4>
                      ...
                      <div>
                        <h4 className="font-medium mb-2">H3 Tags ({result.comprehensiveResults?.h_tags?.h3?.length || 0})</h4>
                        <div className="space-y-1 max-h-32 overflow-y-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Card>
                    <CardHeader>
                      <CardTitle className="flex items-center gap-2">
                        <CheckCircle className="h-5 w-5 text-green-500" />
                        ARIA & Accessibility Passed ({result.comprehensiveResults?.accessibility?.passed_checks?.length || 0})
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-2">
              ...
              <TabsContent value="performance" className="space-y-6">
                ...
                {result.comprehensiveResults?.performance_diagnostics && result.comprehensiveResults.performance_diagnostics.length > 0 && (
                  <Card>
                    <CardHeader>
                      <CardTitle className="flex items-center gap-2">
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        {result.comprehensiveResults.performance_diagnostics.slice(0, 8).map((diagnostic, index) => (
                          <div key={index} className="flex items-start gap-3 p-4 border rounded-lg">
                            <div className="flex-1">
                    ...
                    <CardContent>
                      <div className="space-y-2">
                        ...
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="font-medium">{formatBytes(result.comprehensiveResults?.stats?.scripts_size || 0)}</span>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          <span>Text Size:</span>
                          <span className="font-medium">{formatBytes(result.comprehensiveResults?.stats?.text_size || 0)}</span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span>Text Ratio:</span>
                          <span className="font-medium">{((result.comprehensiveResults?.stats?.text_rate || 0) * 100).toFixed(1)}%</span>
                    ...
                    <CardContent>
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="font-medium">{result.comprehensiveResults?.stats?.images_count || 0}</span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span>Images Size:</span>
                          <span className="font-medium">{formatBytes(result.comprehensiveResults?.stats?.images_size || 0)}</span>
              ...
              <TabsContent value="recommendations" className="space-y-6">
                {/* Quick Wins */}
                {result.comprehensiveResults?.quick_wins && result.comprehensiveResults.quick_wins.length > 0 && (
                  <Card>
                    <CardHeader>
                      <CardTitle className="flex items-center gap-2">
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        {result.comprehensiveResults.quick_wins.map((win, index) => (
                          <div key={index} className="flex items-start gap-3 p-4 border rounded-lg bg-yellow-50 dark:bg-yellow-900/20">
                            ...
                            <div className="flex-1">
                              ...
                              {win.current_value && win.recommended_value && (
                                <div className="mt-2 text-xs">
                                  ...
                                  {' → '}
                                  <span className="text-green-600">Recommended: {win.recommended_value}</span>
                                </div>
                              )}
                ...
                {/* All Issues */}
                {result.comprehensiveResults?.issues && result.comprehensiveResults.issues.length > 0 && (
                  <Card>
                    <CardHeader>
                      <CardTitle className="flex items-center gap-2">
                          ...
                          <div key={index} className="flex items-start gap-3 p-4 border rounded-lg">
                            ...
                            <div className="flex-1">
                              ...
                              {issue.current_value && issue.expected_value && (
                                <div className="mt-2 text-xs">
                                  <span className="text-red-600">Current: {issue.current_value}</span>
                                  {' → '}
                                  <span className="text-green-600">Expected: {issue.expected_value}</span>
                                </div>
                              )}
